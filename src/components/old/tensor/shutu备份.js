...
var linkenter = g.selectAll(".link")
    ...
    //   return (d.parent.y-d.y) / 4})
    // .text(function(d,i) {
    //   return depth_data[d.depth-1]+":"+link_data[i][0]+"等"+link_data[i].length+"个";
    // })
...
// adds each node as a group
  ...
  nodeEnter.append("circle")
    .attr("r", function(d,i) { return pow(N_all_num[num_tree][i]); })
...
// line.angle(function(d,i){
//   return d.angle;
// });
// line.radius(function(d,i){
//   return d.r
// });
// var shang_history=[[2.70007, 4.75045,  2.94006],
// [0.99826, 4.66223,  2.94689],
// [2.31945, 4.75877,  2.93879],
// [2.31936, 4.59578,  2.30817],
// [ 2.31974, 4.76351,  2.26549],
// [2.32154, 1.55257,  2.29202],
// [2.31777, 3.00681,  2.30105],
// [ 2.31817, 1.33383,  2.30951],
// [ 2.31703, 1.06698,  2.29393],
// [2.31832, 3.33447,  2.31382],
// ];
// var shang_ce=[[2.73125, 3.86883,  2.79315],
// [0.99956, 2.84922,  2.79266],
// [2.30779, 4.01637,  2.78759],
// [2.30631, 3.85167,  2.29468],
// [2.30925, 4.54822,  2.20577],
// [2.31390, 0.94845,  2.26219],
// [2.28990, 2.99299,  2.28379],
// [2.12084, 1.42657,  2.28980],
// [2.24200, 1.15678,  2.28439],
// [2.29967, 2.88134,  2.30837],
// ];
// var shang_all=[shang_history,shang_ce];
// var Scale = d3.scaleLinear()
//                 .domain([0, 5])
//                 .range([0,15]);

// nodeenter.enter().append("path")
//          .attr("class","line")
//          // .attr("d",line(arr))
//          .attr("d",function(d,i){
//           var n=60;
//           var wei_3=[Scale(shang_all[num][i][0]),Scale(shang_all[num][i][1]),Scale(shang_all[num][i][2])];

//           var r_small=pow(N_all_num[num][i]);
//           var per=2*Math.PI/n;

//           var chushi=-2*Math.PI/6
//           var arr=[];

//           for(var j=0;j<=n;j++){
//             var wei=parseInt(j/parseInt(n/3))
//             if(j%2){
//               arr.push({r:r_small+wei_3[wei],angle:chushi+per*j});
//             }else{
//               arr.push({r:r_small,angle:chushi+per*j});
//             }
//           } 
//             return line(arr);
//          })
